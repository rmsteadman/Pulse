...
export class SignUpService {
  ...
  public getUserToken() : Observable<any> {
    return this.http.get('https://ec2-54-67-94-166.us-west-1.compute.amazonaws.com:443/api/users/gettoken')
      .map(data => {
        return data.json();
      })
  }
  ...
  public signupPost(user): Observable<any> {
    ...
    return this.http.post('https://ec2-54-67-94-166.us-west-1.compute.amazonaws.com:443/api/users/signup', user)
      .map(data => {
